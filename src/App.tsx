                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-center justify-center gap-2">
                      <Badge>{item.start}</Badge>
                      <Badge variant="secondary">{item.end}</Badge>
                      <span className="text-sm text-muted-foreground">
                        Termin A von Herr Müllers sddaada
                      </span>
                      <Badge variant="outline">stattgefunden</Badge>
                      <button
                        type="button"
                      ...
                      <button
                        ...
                        onClick={() => {
                          console.log("Du klickst den Lösch Button.");
                        }}
                        aria-label="Löschen"
                      >
                        <svg
